...
export const Categories = ({ currentCategory, setCurrentCategory}: {
...
export const CategoryItem = ({item, index, currentCategory, setCurrentCategory }: {
    item: string, 
    index: number, 
    currentCategory: string | null,
    setCurrentCategory: Dispatch<SetStateAction<string | null>>
    ...
    return (
        <Animated.View entering={FadeInRight.delay(index * 200).duration(2000).springify()}>
